      ...
      <div className="hero-split-card">
        ...
        <div className="hero-split-inner">
          ...
          <div className="hero-split-actions">
            <a href="/" className="btn-primary hero-split-btn" onClick={(e) => smoothScroll(e, '/#categories', pathname, router)}>
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                <path d="M12 20h9M16.5 3.5a2.121 2.121 0 013 3L7 19l-4 1 1-4L16.5 3.5z" />
              </svg>
              Start Your Design
            </a>
            <a href="/" className="btn-outline hero-split-btn" onClick={(e) => smoothScroll(e, '/#gallery', pathname, router)}>View Our Craft</a>
          </div>
